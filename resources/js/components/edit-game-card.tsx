            ...
            <div className="space-y-1 text-sm text-gray-600">
                <div className="flex flex-row gap-2">
                    <div className="flex flex-col gap-2">
                        <DroppableUser user={game.home_coach ?? null} role="home_coach" gameId={game.id} label="Coach" onUserAssign={onUserAssign} />
                    </div>
                    <div className="flex flex-col gap-2">
                        <DroppableUser user={game.away_coach ?? null} role="away_coach" gameId={game.id} label="Coach" onUserAssign={onUserAssign} />
                    </div>
                </div>
                <div className="flex flex-row gap-2">
                    <div className="flex flex-col gap-2">
                        <DroppableUser user={game.home_referee ?? null} role="home_referee" gameId={game.id} label="Referee" onUserAssign={onUserAssign} />
                    </div>
                    <div className="flex flex-col gap-2">
                        <DroppableUser user={game.away_referee ?? null} role="away_referee" gameId={game.id} label="Referee" onUserAssign={onUserAssign} />
                    </div>
                </div>
            </div>
        </div>
